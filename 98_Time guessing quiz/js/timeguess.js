...
const timer = document.getElementById("timer"); //false 7
const start = document.getElementById("start");
const stop = document.getElementById("stop"); // false 6
...
// Startボタンクリック
////////////////////////
start.addEventListener("click",//false 8
  function () {
    if (soundEndflag === "1") {
      soundControl("end", "");
    }
...
// Stopボタンクリック
////////////////////////
stop.addEventListener("click", // false 2
  function () {
    // タイマーを"停止中"状態とする
    setButtonStateStopped(); //false 9
...
reset.addEventListener("click",
  function () {
    ...
    body.style.backgroundColor = "rgba(233,168,277,0.6)";
  }
);
...
function setButtonStateStopped() {
  ...
  timer.classList.add("timer_appear"); //時間をゆっくり表示 //false 5
